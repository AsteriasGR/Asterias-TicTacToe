...
public class TicTacToe implements ActionListener{
	...
	TicTacToe() {
		...
		for(int i=0;i<9;i++) {
			...
			buttons[i].setFont(new Font("TimesNewRoman",Font.BOLD,120));
	...
	public void xWins(int a, int b, int c) {
		...
		textfield.setText("You win this time X!");
	...
	public void oWins(int a, int b, int c) {
		...
		textfield.setText("You win this time O!");
